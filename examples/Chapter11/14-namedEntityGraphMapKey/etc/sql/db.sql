...
CREATE TABLE EMPLOYEE (ID INTEGER NOT NULL, FIRSTNAME VARCHAR(255), LASTNAME VARCHAR(255), SALARY BIGINT, STARTDATE DATE, ADDRESS_ID INTEGER, DEPARTMENT_ID INTEGER, MANAGER_ID INTEGER, PRIMARY KEY (ID));
...
INSERT INTO EMPLOYEE (ID, FIRSTNAME, LASTNAME, SALARY, STARTDATE, ADDRESS_ID, DEPARTMENT_ID, MANAGER_ID) VALUES (1, 'John', 'Brock', 55000, {d '2001-01-01'}, 1, 2, 9);
INSERT INTO EMPLOYEE (ID, FIRSTNAME, LASTNAME, SALARY, STARTDATE, ADDRESS_ID, DEPARTMENT_ID, MANAGER_ID) VALUES (2, 'Rob', 'Dreats', 53000, {d '2001-05-23'}, 2, 2, 9);
INSERT INTO EMPLOYEE (ID, FIRSTNAME, LASTNAME, SALARY, STARTDATE, ADDRESS_ID, DEPARTMENT_ID, MANAGER_ID) VALUES (3, 'Peter', 'Leeds', 40000, {d '2002-08-06'}, 3, 2, 9);
INSERT INTO EMPLOYEE (ID, FIRSTNAME, LASTNAME, SALARY, STARTDATE, ADDRESS_ID, DEPARTMENT_ID, MANAGER_ID) VALUES (4, 'Frank', 'Payle', 41000, {d '2003-02-17'}, 4, 1, 10);
INSERT INTO EMPLOYEE (ID, FIRSTNAME, LASTNAME, SALARY, STARTDATE, ADDRESS_ID, DEPARTMENT_ID, MANAGER_ID) VALUES (5, 'Scott', 'Prince', 60000, {d '2004-11-14'}, 5, 1, 10);
INSERT INTO EMPLOYEE (ID, FIRSTNAME, LASTNAME, SALARY, STARTDATE, ADDRESS_ID, DEPARTMENT_ID, MANAGER_ID) VALUES (6, 'Sue', 'Black', 62000, {d '2005-08-18'}, 6, 1, 10);
INSERT INTO EMPLOYEE (ID, FIRSTNAME, LASTNAME, SALARY, STARTDATE, ADDRESS_ID, DEPARTMENT_ID, MANAGER_ID) VALUES (7, 'Stephanie', 'White', 54000, {d '2006-06-07'}, 7, 1, 10);
INSERT INTO EMPLOYEE (ID, FIRSTNAME, LASTNAME, SALARY, STARTDATE, ADDRESS_ID, DEPARTMENT_ID, MANAGER_ID) VALUES (8, 'Jennifer', 'Brown', 45000, {d '1999-08-11'}, 8, 1, NULL);
INSERT INTO EMPLOYEE (ID, FIRSTNAME, LASTNAME, SALARY, STARTDATE, ADDRESS_ID, DEPARTMENT_ID, MANAGER_ID) VALUES (9, 'Sarah', 'McCullough', 52000, {d '2002-04-26'}, 9, 2, 10);
INSERT INTO EMPLOYEE (ID, FIRSTNAME, LASTNAME, SALARY, STARTDATE, ADDRESS_ID, DEPARTMENT_ID, MANAGER_ID) VALUES (10, 'Joan', 'Craw', 59000, {d '2003-04-16'}, 10, 1, NULL);
INSERT INTO EMPLOYEE (ID, FIRSTNAME, LASTNAME, SALARY, STARTDATE, ADDRESS_ID, DEPARTMENT_ID, MANAGER_ID) VALUES (11, 'Marcus', 'Henning', 35000, {d '1995-07-22'}, NULL, NULL, NULL);
INSERT INTO EMPLOYEE (ID, FIRSTNAME, LASTNAME, SALARY, STARTDATE, ADDRESS_ID, DEPARTMENT_ID, MANAGER_ID) VALUES (12, 'Joe', 'Robbins', 36000, {d '1995-07-22'}, NULL, 3, 11);
INSERT INTO EMPLOYEE (ID, FIRSTNAME, LASTNAME, SALARY, STARTDATE, ADDRESS_ID, DEPARTMENT_ID, MANAGER_ID) VALUES (13, 'Jack', 'Smith', 43000, {d '1995-07-22'}, NULL, 3, NULL);
